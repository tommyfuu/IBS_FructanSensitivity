...
def all_heatmap(csv_path, csv_colNames, resultFile, out):
    ...
    plt.savefig("0811/dendo/dendo"+out, dpi=300)
    plt.close()
    # time.sleep(15)
    ...
    plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
           bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
    plt.savefig("0811/nodendo/nodendo"+out, dpi=300)
    plt.close()
    ...
    plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
           bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
    plt.savefig("0811/dendoCol/dendoCol"+out, dpi=300)
    plt.close()
    ...
    plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
           bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
    plt.savefig("0811/nodendoCol/nodendoCol"+out, dpi=300)
    plt.close()
    ...
    df.to_csv("0811/"+out+'heatmap_up_down_summary.csv')
# def all_heatmap(csv_path, csv_colNames, out):
...
#     # 1 generate cluster map (dendo version)
#     # g = sns.clustermap(data, cmap="YlGnBu", col_cluster=False, cbar_kws={"orientation": "horizontal"}, col_colors = [color_rows])
#     g = sns.clustermap(data, cmap="vlag", col_cluster=False, cbar_kws={"orientation": "horizontal"}, col_colors = [color_rows], 
#     vmin=-4, vmax=4)
...
#     plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
#            bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
#     plt.savefig("0620/dendo/dendo"+out, dpi=300)
#     plt.close()
#     # time.sleep(15)


#     # 2 generate cluster map (no dendo version)
#     g = sns.clustermap(data, cmap="vlag", col_cluster=False, cbar_kws={"orientation": "vertical"}, col_colors = [color_rows])
#     g.ax_cbar.set_position([x0, 0.9, g.ax_row_dendrogram.get_position().width, 0.05])
#     g.ax_cbar.set_title('z score')
#     g.ax_row_dendrogram.set_visible(False)
#     dendro_box = g.ax_row_dendrogram.get_position()
...
#     plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
#            bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
#     plt.savefig("0620/nodendo/nodendoCol"+out, dpi=300)
#     plt.close()


#     # 3 generate cluster map (dendo version) (all clustered)
#     g = sns.clustermap(data, cmap="vlag", cbar_kws={"orientation": "horizontal"}, col_colors = [color_rows])
#     g.ax_row_dendrogram.set_visible(True)
#     x0, _y0, _w, _h = g.cbar_pos
#     g.ax_cbar.set_position([x0, 0.9, g.ax_row_dendrogram.get_position().width, 0.05])
#     g.ax_cbar.set_title('z score')
...
#     plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
#            bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
#     plt.savefig("0620/dendoCol/dendoCol"+out, dpi=300)
#     plt.close()

#     # 4 generate cluster map (no dendo version) (all clustered)
#     g = sns.clustermap(data, cmap="vlag", cbar_kws={"orientation": "vertical"}, col_colors = [color_rows])
#     g.ax_cbar.set_position([x0, 0.9, g.ax_row_dendrogram.get_position().width, 0.05])
#     g.ax_cbar.set_title('z score')
#     g.ax_row_dendrogram.set_visible(False)
#     dendro_box = g.ax_row_dendrogram.get_position()
...
#     plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
#            bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
#     plt.savefig("0620/nodendoCol/nodendoCol"+out, dpi=300)
#     plt.close()
...
def per_diet_heatmap(csv_path_l, result_path_l, omicNames, csv_colNames, out):
    ...
    # finalData.to_csv("AAAAAAA.csv")
    # generate color labelling
    # sampleNames = list(finalData.columns)
    print(sampleNames)
    print("AAAAAAA")
    # time.sleep(15)
    color_dict = {}
    ...
    plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
           bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
    plt.savefig("0811combo/dendo/dendo"+out, dpi=300)
    plt.close()
    ...
    plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
           bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
    plt.savefig("0811combo/nodendo/nodendo"+out, dpi=300)
    plt.close()
    ...
    plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
           bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
    plt.savefig("0811combo/dendoCol/dendoCol"+out, dpi=300)
    plt.close()
    ...
    plt.legend([Patch(facecolor=palette[0]), Patch(facecolor=palette[1])], ["sensitive", "tolerant"], title='Fructan Sensitivity',
           bbox_to_anchor=(1, 1), bbox_transform=plt.gcf().transFigure, loc='upper right')
    plt.savefig("0811combo/nodendoCol/nodendoCol"+out, dpi=300)
    plt.close()

    df = pd.DataFrame(list(zip(omicNames, numAll, numTol, numSen)),
               columns =['omics', 'number of biomarkers in total', 'number enriched in tolerant kids', 'number enriched in sensitive kids'])

    df.to_csv("0811combo/"+out+'heatmap_up_down_summary.csv')
...
all_csv_path_l = ["./finalStuff/humann3KruskalFinalFeatures_all_heatmapOutput.csv",
"./finalStuff/lipidomicsKruskalFinalFeatures_all_heatmapOutput.csv",
"./finalStuff/metabolitesKruskalFinalFeatures_all_heatmapOutput.csv",
"./finalStuff/metaphlanKruskalFinalFeatures_all_heatmapOutput.csv"]

omicNames_all = ['humann3', 'lipidomics', 'metabolites', 'metaphlan']

result_file_l = ['/Users/chenlianfu/Documents/GitHub/IBSFructanCodes/WGS_KruskalWallis/kruskalOutputs/kruskal.Humann3.all.052522aovResults.xls',
...
all_csv_colNames = ["./kruskalOutputs/kruskal.Humann3.all.052522heatmapSampleMatch.csv", 
"./kruskalOutputs/kruskal.Lipids.all.052522heatmapSampleMatch.csv",
"./kruskalOutputs/kruskal.Metabolites.all.052522heatmapSampleMatch.csv",
"./kruskalOutputs/kruskal.Metaphlan.all.052522heatmapSampleMatch.csv"
]

per_diet_heatmap(all_csv_path_l, result_file_l, omicNames_all, all_csv_colNames, "allDiet.pdf")

all_csv_path_l = ["./finalStuff/lipidomicsKruskalFinalFeatures_AAndBS_heatmapOutput.csv",
"./finalStuff/metabolitesKruskalFinalFeatures_AAndBS_heatmapOutput.csv",
"./finalStuff/metaphlanKruskalFinalFeatures_AAndBS_heatmapOutput.csv"]

omicNames_all = ['lipidomics', 'metabolites', 'metaphlan']

result_file_l = ['/Users/chenlianfu/Documents/GitHub/IBSFructanCodes/WGS_KruskalWallis/kruskalOutputs/kruskal.Lipids.AAndBS.052522aovResults.xls',
...
all_csv_colNames = ["./kruskalOutputs/kruskal.Lipids.AAndBS.052522heatmapSampleMatch.csv",
"./kruskalOutputs/kruskal.Metabolites.AAndBS.052522heatmapSampleMatch.csv",
"./kruskalOutputs/kruskal.Metaphlan.AAndBS.052522heatmapSampleMatch.csv"
]

per_diet_heatmap(all_csv_path_l, result_file_l, omicNames_all, all_csv_colNames, "AAndBSDiet.pdf")

all_csv_path_l = ["./finalStuff/lipidomicsKruskalFinalFeatures_BAndBS_heatmapOutput.csv",
"./finalStuff/metabolitesKruskalFinalFeatures_BAndBS_heatmapOutput.csv",
"./finalStuff/metaphlanKruskalFinalFeatures_BAndBS_heatmapOutput.csv"]

omicNames_all = ['lipidomics', 'metabolites', 'metaphlan']

result_file_l = ['/Users/chenlianfu/Documents/GitHub/IBSFructanCodes/WGS_KruskalWallis/kruskalOutputs/kruskal.Lipids.BAndBS.052522aovResults.xls',
...
all_csv_colNames = ["./kruskalOutputs/kruskal.Lipids.BAndBS.052522heatmapSampleMatch.csv",
"./kruskalOutputs/kruskal.Metabolites.BAndBS.052522heatmapSampleMatch.csv",
"./kruskalOutputs/kruskal.Metaphlan.BAndBS.052522heatmapSampleMatch.csv"
]

per_diet_heatmap(all_csv_path_l, result_file_l, omicNames_all, all_csv_colNames, "BAndBSDiet.pdf")


all_csv_path_l = ["./finalStuff/lipidomicsKruskalFinalFeatures_BS_heatmapOutput.csv"]

omicNames_all = ['lipidomics']

result_file_l = ['/Users/chenlianfu/Documents/GitHub/IBSFructanCodes/WGS_KruskalWallis/kruskalOutputs/kruskal.Lipids.BS.052522aovResults.xls']

all_csv_colNames = ["./kruskalOutputs/kruskal.Lipids.BS.052522heatmapSampleMatch.csv"]

per_diet_heatmap(all_csv_path_l, result_file_l, omicNames_all, all_csv_colNames, "BSDiet.pdf")


all_csv_path_l = ["./finalStuff/metabolitesKruskalFinalFeatures_AAndB_heatmapOutput.csv"]

omicNames_all = ['metabolites']

result_file_l = ['/Users/chenlianfu/Documents/GitHub/IBSFructanCodes/WGS_KruskalWallis/kruskalOutputs/kruskal.Metabolites.AAndB.052522aovResults.xls',]

all_csv_colNames = ["./kruskalOutputs/kruskal.Lipids.AAndB.052522heatmapSampleMatch.csv"]
